# Ganache a Sözleşme Deoploy Etme ve Etkileşim
...
#Local Blockchain Ganache a sözleşme Deploy Etme
web3_baglantisi= Web3(Web3.HTTPProvider("HTTP://127.0.0.1:7545"))
print(bool(web3_baglantisi))


zincir_id= 5777

adresim = "" #Ganache deki ilk hesap 

adres_gizli_anahtari= "" #Ganache deki ilk hesabın private key i

# #Sözleşmeyi Python içinde oluşturacağız, bir instance sini alacağız
...
Merhaba_Dunya_GanacheDeyiz = web3_baglantisi.eth.contract(address= islem_adisyon.contractAddress,  abi= MerhabaDunya_abi)
print(Merhaba_Dunya_GanacheDeyiz)



print(Merhaba_Dunya_GanacheDeyiz.functions.SonucYazdir().call())
print("tamamdir", Merhaba_Dunya_GanacheDeyiz.functions.mesajiAyarla("selamKurs").call())
print("devamdir", Merhaba_Dunya_GanacheDeyiz.functions.mesajiSoyle().call())
...
#1 işlem oluştur
mesaji_ayarla_islemi = Merhaba_Dunya_GanacheDeyiz.functions.mesajiAyarla("selamKurs").build_transaction({"from": adresim, "nonce": nonce_degeri +1 })
...
print(mesaji_ayarla_islem_adisyonu)

print("devamdir versiyon 2", Merhaba_Dunya_GanacheDeyiz.functions.mesajiSoyle().call())
